              ...
              <div class="left-sidebar-content">
                <ul class="sidebar-elements">
                  ...
                  <li class="parent"><a href="#"><i class="icon mdi mdi-face"></i><span><?php echo $row->pass_uname;?>'s Profile</span></a>
                    ...
                    <?php }?>
                  <li class="parent"><a href="#"><i class="icon mdi mdi-train"></i><span>Taxis</span></a>
                  ...
                  <li class="parent"><a href="#"><i class="icon mdi mdi-briefcase-edit-outline"></i><span>Book taxi</span></a>
                    <ul class="sub-menu">
