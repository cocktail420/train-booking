  ...
  <body>
    ...
    <!--Nav Bar-->
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">Taxi Ticket</h2>
            ...
            <!--Train Details-->
              <div id='printReceipt' class="invoice">
                <div class="row invoice-header">
                  ...
                  <div class="col-sm-5 invoice-order"><span class="invoice-id">Taxi Ticket For</span><span class="incoice-date"><?php echo $row->pass_fname;?> <?php echo $row->pass_lname;?></span></div>
                </div>
                  ...
                  <div class="col-lg-12">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>ksh.<?php echo $row->pass_train_fare;?></td>
                      </tr>
                      <hr>
                        <?php }?>
                    </tbody>
